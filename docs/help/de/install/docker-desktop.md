...
- **AdaptiveLearners eigene Container sind Open Source.** Deine Buchdaten liegen in einem Docker-Volume auf deinem Computer; nichts wird irgendwohin gesendet, solange du nicht selbst exportierst oder ein Backup erstellst.
...
- ~4 GB freier RAM
- ~5 GB Speicherplatz (Docker selbst plus AdaptiveLearners Container)
...
5. Jetzt kannst du den AdaptiveLearner-Launcher starten.
...
Sobald Docker installiert ist und läuft, kehre zum AdaptiveLearner-Launcher zurück und klicke auf „Verstanden, weiter". AdaptiveLearner erkennt Docker, lädt sich selbst herunter und startet.
