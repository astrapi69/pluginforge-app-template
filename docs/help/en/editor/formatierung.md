...
AdaptiveLearner supports the usual text formatting options you know from word processors. All of them are reachable via the toolbar or keyboard shortcuts:
...
AdaptiveLearner supports two list types:
