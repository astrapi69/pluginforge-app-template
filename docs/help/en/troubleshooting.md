...
If you are running AdaptiveLearner via Docker (`make prod`), Pandoc and LaTeX are already inside the container; in that case the cause is more likely a configuration issue.
